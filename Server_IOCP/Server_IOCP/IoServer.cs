...
namespace Server_IOCP
{
    ...
    internal sealed class IoServer
    {
        ...
        private void ProcessError(SocketAsyncEventArgs e)
        {
            ...
            mainForm.Dispatcher.BeginInvoke(mainForm.setlistboxcallback, outStr);
        ...
        private void ProcessAccept(SocketAsyncEventArgs e)
        {
            ...
            if (s.Connected)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    mainForm.Dispatcher.BeginInvoke(mainForm.setlistboxcallback, "异常：" + ex.ToString());
                }
                // 投递下一个接受请求
                this.StartAccept(e);
            }
        ...
        internal void Start(string ip, Int32 port)
        {
            // 获得主机相关信息
